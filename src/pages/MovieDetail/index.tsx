...
export default function MovieDetail() {
  ...
  const [diaryForm, setDiaryForm] = useState({ watchDate: getLocalDateStr(), watchTime: nowTime(), rating: 8, review: '' });
  ...
  async function handleAddDiary() {
    ...
    try {
      ...
      setDiaryForm({ watchDate: getLocalDateStr(), watchTime: nowTime(), rating: 8, review: '' });
      showToast('观影记录已添加');
    } catch (err: any) {
    ...
    <div>
      ...
      <div className="detail-hero">
        ...
        <div className="detail-info">
          ...
          <div className="detail-actions">
            <button onClick={() => { setEditingEntryId(null); setDiaryForm({ watchDate: getLocalDateStr(), watchTime: nowTime(), rating: 8, review: '' }); setShowAddDiary(true); }} className="btn btn-primary">
              添加记录
            </button>
      ...
      <div className="diary-section mt-9">
        <div className="diary-section-header">
          ...
          <button onClick={() => { setEditingEntryId(null); setDiaryForm({ watchDate: getLocalDateStr(), watchTime: nowTime(), rating: 8, review: '' }); setShowAddDiary(true); }} className="btn btn-secondary btn-sm">
            添加
          </button>
        </div>
        {entries.length === 0 ? (
